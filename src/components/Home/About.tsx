    ...
    return (
        <div className="relative grid md:grid-cols-2 w-full py-24 px-12 gap-9 ">
            <div className="relative flex flex-col xl:flex-row xl:justify-end p-2 gap-10 xl:gap-0">
                <h1 className="lg:absolute -right-[calc(27vw)] z-50 text-4xl md:text-8xl font-semibold mix-blend-difference">
                    About Design.
                </h1>
            ...
            <div className="flex flex-col gap-10">
                <p className="mt-[calc(10vw)] para-two text-xl leading-normal">
